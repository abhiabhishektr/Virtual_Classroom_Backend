...
const checkCourseOwnership = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const { courseId } = req.body.courseId; // Adjust based on your routes
        const teacherId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null; // Assuming `req.user` contains the authenticated teacher's ID
...
exports.default = checkCourseOwnership;
